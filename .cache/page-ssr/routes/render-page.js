...
// EXTERNAL MODULE: external "/Users/andrel/genuineswe-website/node_modules/react/index.js"
var index_js_ = __webpack_require__(3462);
...
const propErrors=validateSliceProps(props);if(Object.keys(propErrors).length){throw new SlicePropsError(slicesContext.renderEnvironment===`browser`,internalProps.sliceName,propErrors,props.__renderedByLocation);}if(slicesContext.renderEnvironment===`server`){return/*#__PURE__*/(0,jsx_runtime.jsx)(ServerSlice,{...internalProps});}else if(slicesContext.renderEnvironment===`browser`){// in the browser, we'll just render the component as is
return/*#__PURE__*/(0,jsx_runtime.jsx)(InlineSlice,{...internalProps});}else if(slicesContext.renderEnvironment===`engines`||slicesContext.renderEnvironment===`dev-ssr`){// if we're in SSR, we'll just render the component as is
return/*#__PURE__*/(0,jsx_runtime.jsx)(InlineSlice,{...internalProps});}else if(slicesContext.renderEnvironment===`slices`){// we are not yet supporting nested slices
...
var _react = _interopRequireDefault(__webpack_require__(3462));
 ...
 */
var f=__webpack_require__(3462),k=Symbol.for("react.element"),l=Symbol.for("react.fragment"),m=Object.prototype.hasOwnProperty,n=f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p={key:!0,ref:!0,__self:!0,__source:!0};
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3462);
...
var React = _interopRequireWildcard(__webpack_require__(3462));
...
"use strict";
module.exports = require("/Users/andrel/genuineswe-website/node_modules/react/index.js");
...
var _react = __webpack_require__(3462);
...
"use strict";
module.exports = require("/Users/andrel/genuineswe-website/node_modules/react-dom/server.js");
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Ay: () => (/* binding */ Contact),
/* harmony export */   YU: () => (/* binding */ ContactProvider),
/* harmony export */   Yr: () => (/* binding */ useContact)
/* harmony export */ });
/* unused harmony export ContactContext */
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3462);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4848);
// Create context without default implementation to avoid confusion
const ContactContext=/*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.createContext)(null);function useContact(){const context=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(ContactContext);if(!context){throw new Error('useContact must be used within a ContactProvider');}return context;}function ContactProvider({children}){const{0:isOpen,1:setIsOpen}=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);const openContact=()=>setIsOpen(true);const closeContact=()=>setIsOpen(false);// Handle ESC key to close
(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{const handleEsc=e=>{if(e.key==='Escape'&&isOpen){setIsOpen(false);}};window.addEventListener('keydown',handleEsc);return()=>window.removeEventListener('keydown',handleEsc);},[isOpen]);// Prevent body scroll when open
(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{if(isOpen){document.body.style.overflow='hidden';}else{document.body.style.overflow='';}},[isOpen]);return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(ContactContext.Provider,{value:{openContact,closeContact,isOpen},children:children});}// Separate component that doesn't use useContact to avoid circular dependency
function ContactPanel({isOpen,closeContact,openContact}){const contactMethods=[{name:'Email',value:'andrel.sitanggang@gmail.com',href:'mailto:andrel.sitanggang@gmail.com',icon:'✉️'},{name:'LinkedIn',value:'Andrel Karunia Sitanggang',href:'https://www.linkedin.com/in/sitanggangandrel',icon:'💼'},{name:'GitHub',value:'@genuineswe',href:'https://github.com/genuineswe',icon:'💻'}];return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.Fragment,{children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("button",{onClick:isOpen?closeContact:openContact,className:"fixed bottom-8 right-8 bg-accent-cyan text-dark-bg p-4 rounded-full shadow-glow-cyan hover:shadow-glow-blue hover:scale-110 transition-all z-40","aria-label":"Open contact panel","aria-expanded":isOpen,children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("svg",{className:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"})})}),isOpen&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.Fragment,{children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("div",{className:"fixed inset-0 bg-black/70 backdrop-blur-sm z-50 animate-fade-in",onClick:closeContact,"aria-hidden":"true"}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("div",{className:"fixed inset-y-0 right-0 w-full md:w-96 bg-dark-bg-secondary border-l border-dark-bg-tertiary shadow-2xl z-50 animate-slide-down",role:"dialog","aria-modal":"true","aria-labelledby":"contact-title",children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("div",{className:"h-full flex flex-col p-6",children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("div",{className:"flex items-center justify-between mb-6",children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("h2",{id:"contact-title",className:"text-2xl font-bold text-accent-cyan",children:"Get In Touch"}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("button",{onClick:closeContact,className:"p-2 hover:bg-dark-bg-tertiary rounded-lg transition-colors","aria-label":"Close contact panel",children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("svg",{className:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M6 18L18 6M6 6l12 12"})})})]}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("div",{className:"space-y-4 flex-1",children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("p",{className:"text-text-secondary mb-6",children:"Feel free to reach out through any of these channels:"}),contactMethods.map(method=>/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("a",{href:method.href,target:method.href.startsWith('http')?'_blank':undefined,rel:method.href.startsWith('http')?'noopener noreferrer':undefined,className:"block p-4 bg-dark-bg-tertiary rounded-lg hover:bg-dark-bg hover:shadow-glow-cyan transition-all focus:outline-2 focus:outline-accent-cyan",children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("div",{className:"flex items-center gap-3",children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("span",{className:"text-2xl",children:method.icon}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("div",{children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("h3",{className:"font-semibold text-text-primary",children:method.name}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("p",{className:"text-sm text-accent-cyan",children:method.value})]})]})},method.name))]}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("p",{className:"text-sm text-text-muted mt-6 text-center",children:["Press ",/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("kbd",{className:"px-2 py-1 bg-dark-bg-tertiary rounded text-xs",children:"ESC"})," to close"]})]})})]})]});}// Main Contact component that uses the context
function Contact(){const{isOpen,closeContact,openContact}=useContact();return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(ContactPanel,{isOpen:isOpen,closeContact:closeContact,openContact:openContact});}
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3462);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _src_components_Contact__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4555);
...
const wrapRootElement=({element})=>{return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_src_components_Contact__WEBPACK_IMPORTED_MODULE_1__/* .ContactProvider */ .YU,{children:element});};
...
exports.components={"component---src-pages-404-jsx":()=>__webpack_require__.e(/* import() | component---src-pages-404-jsx */ 415).then(__webpack_require__.bind(__webpack_require__, 3729)),"component---src-pages-blog-jsx":()=>__webpack_require__.e(/* import() | component---src-pages-blog-jsx */ 493).then(__webpack_require__.bind(__webpack_require__, 8285)),"component---src-pages-index-jsx":()=>__webpack_require__.e(/* import() | component---src-pages-index-jsx */ 279).then(__webpack_require__.bind(__webpack_require__, 7325)),"component---src-pages-profile-jsx":()=>__webpack_require__.e(/* import() | component---src-pages-profile-jsx */ 436).then(__webpack_require__.bind(__webpack_require__, 6630)),"component---src-pages-projects-jsx":()=>__webpack_require__.e(/* import() | component---src-pages-projects-jsx */ 311).then(__webpack_require__.bind(__webpack_require__, 7811)),"component---src-templates-blog-post-jsx":()=>__webpack_require__.e(/* import() | component---src-templates-blog-post-jsx */ 837).then(__webpack_require__.bind(__webpack_require__, 9567))};
...
"use strict";
module.exports = require("/Users/andrel/genuineswe-website/.cache/ssr-builtin-trackers/fs");
...
const React=__webpack_require__(3462);const{grabMatchParams}=__webpack_require__(5870);const{StaticQueryContext}=__webpack_require__(123);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(3304);const{ServerLocation,Router}=__webpack_require__(6462);const{renderToString}=__webpack_require__(4040);const{parse}=__webpack_require__(6192);const styleToOjbect=__webpack_require__(9108);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
/******/ 			return "" + ({"279":"component---src-pages-index-jsx","311":"component---src-pages-projects-jsx","415":"component---src-pages-404-jsx","436":"component---src-pages-profile-jsx","493":"component---src-pages-blog-jsx","837":"component---src-templates-blog-post-jsx"}[chunkId] || chunkId) + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/* harmony import */ var react_server_dom_webpack_writer_node_server__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8136);
/* harmony import */ var react_server_dom_webpack_writer_node_server__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react_server_dom_webpack_writer_node_server__WEBPACK_IMPORTED_MODULE_1__);
const React=__webpack_require__(3462);const path=__webpack_require__(2003);const{renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(4040);const{ServerLocation,Router,isRedirect}=__webpack_require__(6462);const merge=__webpack_require__(4744);const{StaticQueryContext}=__webpack_require__(123);const fs=__webpack_require__(8181);const{WritableAsPromise}=__webpack_require__(5297);const{RouteAnnouncerProps}=__webpack_require__(6858);const{apiRunner,apiRunnerAsync}=__webpack_require__(9432);const asyncRequires=__webpack_require__(6877);const{version:gatsbyVersion}=__webpack_require__(5818);const{grabMatchParams}=__webpack_require__(5870);const{headHandlerForSSR}=__webpack_require__(8227);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(2024);const{ServerSliceRenderer}=__webpack_require__(8455);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
...
bodyProps=deepMerge({},bodyProps,props);};const getHeadComponents=()=>headComponents;const replaceHeadComponents=components=>{headComponents=sanitizeComponents(components);};const getPreBodyComponents=()=>preBodyComponents;const replacePreBodyComponents=components=>{preBodyComponents=sanitizeComponents(components);};const getPostBodyComponents=()=>postBodyComponents;const replacePostBodyComponents=components=>{postBodyComponents=sanitizeComponents(components);};const{componentChunkName,slicesMap}=pageData;const pageComponent=await asyncRequires.components[componentChunkName]();class RouteHandler extends React.Component{render(){var _pageData$result,_pageData$result$page;const props={...this.props,...pageData.result,params:{...grabMatchParams(this.props.location.pathname),...(((_pageData$result=pageData.result)===null||_pageData$result===void 0?void 0:(_pageData$result$page=_pageData$result.pageContext)===null||_pageData$result$page===void 0?void 0:_pageData$result$page.__params)||{})}};const pageElement=createElement(pageComponent.default,props);const wrappedPage=apiRunner(`wrapPageElement`,{element:pageElement,props},pageElement,({result})=>{return{element:result,props};}).pop();return wrappedPage;}}const routerElement=/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(ServerLocation,{url:`${""}${pagePath}`,children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Router,{id:"gatsby-focus-wrapper",baseuri:"",children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(RouteHandler,{path:"/*"})}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div",{...RouteAnnouncerProps})]});const sliceProps={};let body=apiRunner(`wrapRootElement`,{element:routerElement,pathname:pagePath},routerElement,({result})=>{return{element:result,pathname:pagePath};}).pop();const slicesContext={// if we're in build now, we know we're on the server
...
const slicesDb=new Map();for(const sliceName of Object.values(slicesMap)){const slice=sliceData[sliceName];const{default:SliceComponent}=await getPageChunk(slice);const sliceObject={component:SliceComponent,sliceContext:slice.result.sliceContext,data:slice.result.data};slicesDb.set(sliceName,sliceObject);}body=/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(SlicesResultsContext.Provider,{value:slicesDb,children:body});}body=/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(SlicesContext.Provider,{value:slicesContext,children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(SlicesPropsContext.Provider,{value:sliceProps,children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(SlicesMapContext.Provider,{value:slicesMap,children:body})})});}const bodyComponent=/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(StaticQueryContext.Provider,{value:staticQueryContext,children:body});// Let the site or plugin render the page component.
...
const windowPageData=`/*<![CDATA[*/window.pagePath=${JSON.stringify(pagePath)};${ true?``:0}${inlinePageData?`window.pageData=${JSON.stringify(pageData)};`:``}/*]]>*/`;postBodyComponents.push(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("script",{id:`gatsby-script-loader`,dangerouslySetInnerHTML:{__html:windowPageData}},`script-loader`));if(true){postBodyComponents.push(createElement(ServerSliceRenderer,{sliceId:`_gatsby-scripts`}));}else{}headComponents=reorderHeadComponents(headComponents);apiRunner(`onPreRenderHTML`,{getHeadComponents,replaceHeadComponents,getPreBodyComponents,replacePreBodyComponents,getPostBodyComponents,replacePostBodyComponents,pathname:pagePath,pathPrefix:""});let htmlElement=/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Html,{...bodyProps,headComponents:headComponents,htmlAttributes:htmlAttributes,bodyAttributes:bodyAttributes,preBodyComponents:preBodyComponents,postBodyComponents:postBodyComponents,body:bodyHtml,path:pagePath});if(true){htmlElement=/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(SlicesContext.Provider,{value:slicesContext,children:htmlElement});}const html=`<!DOCTYPE html>${renderToStaticMarkup(htmlElement)}`;return{html,unsafeBuiltinsUsage:global.unsafeBuiltinUsage,sliceData:sliceProps};}catch(e){e.unsafeBuiltinsUsage=global.unsafeBuiltinUsage;throw e;}}function getPageChunk({componentChunkName}){return asyncRequires.components[componentChunkName]();}async function renderSlice({slice,staticQueryContext,props={}}){const{default:SliceComponent}=await getPageChunk(slice);const slicesContext={// we are not yet supporting using <Slice /> placeholders within slice components
...
renderEnvironment:`slices`,sliceRoot:slice};const sliceElement=/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(SliceComponent,{sliceContext:slice.context,...props});const sliceWrappedWithWrapRootElement=apiRunner(`wrapRootElement`,{element:sliceElement},sliceElement,({result})=>{return{element:result};}).pop();const sliceWrappedWithWrapRootElementAndContexts=/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(SlicesContext.Provider,{value:slicesContext,children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(StaticQueryContext.Provider,{value:staticQueryContext,children:sliceWrappedWithWrapRootElement})});const writableStream=new WritableAsPromise();const{pipe}=renderToPipeableStream(sliceWrappedWithWrapRootElementAndContexts,{onAllReady(){pipe(writableStream);},onError(error){writableStream.destroy(error);}});return await writableStream;}
})();
